...
public abstract class DBContract {
	...
	public static abstract class User {
		...
		public static final String SQL_CREATE_ENTRIES = "CREATE TABLE "
				+User.TABLE_NAME+"("
				+User.COLUMN_NAME_ID+" TEXT PRIMARY KEY"+COMMA_SEP
	...
	public static abstract class Measurement {
		...
		public static final String SQL_CREATE_ENTRIES = "CREATE TABLE "
				...
				+Measurement.COLUMN_NAME_MID_NECK_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_BUST_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_WAIST_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_HIP_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_ACROSS_BACK_SHOULDER_WIDTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_SHOULDER_DROP+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_SHOULDER_SLOPE_DEGREES+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_ARM_LENGTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_UPPER_ARM_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_ARMSCYE_GIRTH+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_HEIGHT+NUMBER_TYPE+COMMA_SEP
				+Measurement.COLUMN_NAME_HIP_HEIGHT+NUMBER_TYPE
				+")";
		public static final String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS "
				+ Measurement.TABLE_NAME;
